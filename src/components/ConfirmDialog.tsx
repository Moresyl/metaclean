    ...
    >
      ...
      >
        ...
        <div className="grid gap-1 pr-7">
          <h2 id="confirm-dialog-title" className="font-display text-lg font-semibold">{title}</h2>
          <p id="confirm-dialog-description" className="text-sm leading-relaxed text-muted">{description}</p>
        </div>
