...
| Localization | 25 selectable locales, with many non-English catalogs reporting partial coverage | 18 complete interface locales; system detection, persisted selection and tested static/dynamic coverage | Gap remains on locale count |
