...
- Local Windows release run on 2026-09-12 produced: 128 files / 25,014,272 payload bytes; scan 1,233.23 files/s; clean 153.06 files/s; first cleanup result 1.45 ms; cleanup p95 16.84 ms. The mixed 128-item run (96 valid, 32 failed) produced scan 1,292.44 files/s; clean 195.92 files/s; first result 1.44 ms; result p95 16.51 ms. These are workstation baselines, not hardware-independent service-level objectives.
