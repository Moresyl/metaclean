...
| M1: desktop MVP | Complete | Batch drag/drop, recursive file/folder intake, native pickers, per-file scan reports, safe-copy/replace modes, forced backup, atomic writes, version discovery and five complete interface locales are implemented and tested. |
...
- Frontend: 61 tests. Statements 91.32%, branches 81.93%, functions 88.57%, lines 95.56%.
