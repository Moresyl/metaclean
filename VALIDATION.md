...
| M1: desktop MVP | Complete | Batch drag/drop, recursive file/folder intake, native pickers, per-file scan reports, safe-copy/replace modes, forced backup, atomic writes, version discovery and eighteen complete interface locales are implemented and tested. |
...
- Frontend: 61 tests. Statements 93.71%, branches 86.50%, functions 93.75%, lines 97.18%.
