...
| M1: desktop MVP | Complete | Batch drag/drop, recursive file/folder intake, native pickers, per-file scan reports, safe-copy/replace modes, forced backup, atomic writes, version discovery and twenty-one complete interface locales are implemented and tested. |
...
- Frontend: 61 tests. Statements 93.93%, branches 86.93%, functions 94.10%, lines 97.38%.
