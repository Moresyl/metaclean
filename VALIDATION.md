...
- Frontend regression tests cover update-dialog focus containment/restoration, direct queue path copying, duplicate-safe native batch handling, delayed progress-event isolation, cleanup cancellation and path-free interrupted-batch recovery; native close requests are blocked while an active scan or cleanup task is registered.
