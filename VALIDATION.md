...
| M1: desktop MVP | Complete | Batch drag/drop, recursive file/folder intake, native pickers, per-file scan reports, safe-copy/replace modes, forced backup, atomic writes, version discovery and twelve complete interface locales are implemented and tested. |
...
- Frontend: 61 tests. Statements 92.81%, branches 80.23%, functions 91.93%, lines 96.65%.
