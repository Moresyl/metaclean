...
| M1: desktop MVP | Complete | Batch drag/drop, recursive file/folder intake, native pickers, per-file scan reports, safe-copy/replace modes, forced backup, atomic writes, version discovery and eight complete interface locales are implemented and tested. |
...
- Frontend: 61 tests. Statements 92.01%, branches 80.92%, functions 90.56%, lines 96.03%.
