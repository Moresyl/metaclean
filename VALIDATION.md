...
- Local Windows release run on 2026-09-12 produced: 128 files / 25,014,272 payload bytes; scan 1,319.13 files/s; clean 150.46 files/s; first cleanup result 1.21 ms; cleanup p95 16.74 ms. The mixed 128-item run (96 valid, 32 failed) produced scan 1,295.24 files/s; clean 191.93 files/s; first result 2.30 ms; result p95 16.89 ms. These are workstation baselines, not hardware-independent service-level objectives.
