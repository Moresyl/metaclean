...
- Local Windows release run on 2026-09-12 produced: 128 files / 25,014,272 payload bytes; scan 1,347.86 files/s; clean 156.76 files/s; first cleanup result 1.04 ms; cleanup p95 15.56 ms. These are a workstation baseline, not a hardware-independent service-level objective.
