...
![MetaClean 桌面工作区](../assets/metaclean-screenshot.png)

## 实际操作

![导入、扫描、搜索和生成安全副本](../assets/metaclean-workflow-zh.gif)

演示使用合成示例文件和真实桌面引擎，播放两轮后停止。

![清理前的逐文件扫描结果](../assets/metaclean-scan-zh.png)

队列搜索支持文件名和原始、输出、备份路径；支持大小写与全角字符归一化，
路径中的正反斜杠均可匹配。下拉框可筛选待清理项或失败项，Escape 清除筛选。
**筛选仅改变显示，批量操作仍针对整个队列。** 待清理筛选会遵循当前 ICC 与
