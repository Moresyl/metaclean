...
- Eighteen complete interface languages, spanning both Chinese scripts, Western, Eastern and Nordic Europe, Japanese and Korean; system/light/dark theme, output mode, fidelity options, and local cleanup history persist between sessions
