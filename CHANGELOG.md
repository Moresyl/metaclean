...
- Twenty-one complete interface catalogs, spanning both Chinese scripts, Western,
  Central, Eastern and Nordic Europe, Japanese and Korean. System-language detection,
