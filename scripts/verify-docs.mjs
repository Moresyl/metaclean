...
assert.match(validation, /Frontend: 367 tests\. Statements 88\.83%, branches 83\.69%, functions 91\.25%, lines 92\.59%/u, "frontend coverage evidence must match the latest full run");
