...
assert.match(validation, /Frontend: 372 tests\. Statements 88\.86%, branches 83\.74%, functions 91\.36%, lines 92\.63%/u, "frontend coverage evidence must match the latest full run");
