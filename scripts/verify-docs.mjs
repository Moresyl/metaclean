...
assert.match(validation, /Frontend: 360 tests\. Statements 88\.73%, branches 83\.58%, functions 91\.25%, lines 92\.56%/u, "frontend coverage evidence must match the latest full run");
