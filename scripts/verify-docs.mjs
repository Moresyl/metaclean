...
assert.match(validation, /Frontend: 363 tests\. Statements 88\.75%, branches 83\.62%, functions 91\.25%, lines 92\.57%/u, "frontend coverage evidence must match the latest full run");
