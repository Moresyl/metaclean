...
assert.match(validation, /Frontend: 365 tests\. Statements 88\.81%, branches 83\.65%, functions 91\.25%, lines 92\.58%/u, "frontend coverage evidence must match the latest full run");
