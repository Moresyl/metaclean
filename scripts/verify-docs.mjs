...
assert.match(validation, /Frontend: 350 tests\. Statements 88\.78%, branches 83\.52%, functions 91\.21%, lines 92\.54%/u, "frontend coverage evidence must match the latest full run");
