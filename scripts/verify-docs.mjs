...
assert.match(validation, /Frontend: 371 tests\. Statements 88\.91%, branches 83\.81%, functions 91\.36%, lines 92\.67%/u, "frontend coverage evidence must match the latest full run");
