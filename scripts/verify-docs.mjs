...
assert.match(validation, /Frontend: 365 tests\. Statements 88\.80%, branches 83\.64%, functions 91\.25%, lines 92\.57%/u, "frontend coverage evidence must match the latest full run");
