...
assert.match(validation, /Frontend: 351 tests\. Statements 88\.77%, branches 83\.44%, functions 91\.21%, lines 92\.53%/u, "frontend coverage evidence must match the latest full run");
