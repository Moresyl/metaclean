...
assert.match(validation, /Frontend: 368 tests\. Statements 88\.87%, branches 83\.73%, functions 91\.24%, lines 92\.62%/u, "frontend coverage evidence must match the latest full run");
