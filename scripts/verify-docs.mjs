...
assert.match(validation, /Frontend: 379 tests\. Statements 88\.88%, branches 83\.91%, functions 91\.37%, lines 92\.64%/u, "frontend coverage evidence must match the latest full run");
