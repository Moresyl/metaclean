...
assert.match(validation, /Frontend: 375 tests\. Statements 88\.89%, branches 83\.85%, functions 91\.37%, lines 92\.62%/u, "frontend coverage evidence must match the latest full run");
