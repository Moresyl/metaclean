...
assert.match(validation, /Frontend: 393 tests\. Statements 89\.46%, branches 84\.25%, functions 92\.01%, lines 93\.25%/u, "frontend coverage evidence must match the latest full run");
