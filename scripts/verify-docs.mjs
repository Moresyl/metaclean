...
assert.match(validation, /Frontend: 394 tests\. Statements 89\.51%, branches 84\.30%, functions 92\.01%, lines 93\.29%/u, "frontend coverage evidence must match the latest full run");
