...
assert.match(validation, /Frontend: 378 tests\. Statements 88\.88%, branches 83\.87%, functions 91\.37%, lines 92\.64%/u, "frontend coverage evidence must match the latest full run");
