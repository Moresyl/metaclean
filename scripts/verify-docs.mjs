...
assert.match(validation, /Frontend: 372 tests\. Statements 88\.88%, branches 83\.76%, functions 91\.37%, lines 92\.61%/u, "frontend coverage evidence must match the latest full run");
