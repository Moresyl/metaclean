...
assert.match(validation, /Frontend: 395 tests\. Statements 89\.51%, branches 84\.41%, functions 92\.01%, lines 93\.30%/u, "frontend coverage evidence must match the latest full run");
