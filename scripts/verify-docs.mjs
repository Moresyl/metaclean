...
assert.match(validation, /Frontend: 377 tests\. Statements 88\.9%, branches 83\.91%, functions 91\.36%, lines 92\.63%/u, "frontend coverage evidence must match the latest full run");
