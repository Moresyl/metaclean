...
assert.match(validation, /Frontend: 362 tests\. Statements 88\.71%, branches 83\.56%, functions 91\.25%, lines 92\.57%/u, "frontend coverage evidence must match the latest full run");
