...
assert.match(validation, /Frontend: 369 tests\. Statements 88\.90%, branches 83\.89%, functions 91\.36%, lines 92\.64%/u, "frontend coverage evidence must match the latest full run");
