...
assert.match(validation, /Frontend: 380 tests\. Statements 88\.89%, branches 83\.91%, functions 91\.37%, lines 92\.65%/u, "frontend coverage evidence must match the latest full run");
