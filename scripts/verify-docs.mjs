...
assert.match(validation, /Frontend: 388 tests\. Statements 89\.12%, branches 83\.96%, functions 91\.87%, lines 92\.86%/u, "frontend coverage evidence must match the latest full run");
