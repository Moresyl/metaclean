...
assert.match(docsHome, /<b>84\.19%<\/b>/u, "documentation home coverage must match the current validation evidence");
assert.match(validation, /84\.19% Rust line coverage/u, "documentation validation must expose the current coverage evidence");
